...
import type { ClaimAdminResult as _ClaimAdminResult, DeliveryAddress as _DeliveryAddress, Order as _Order, OrderId as _OrderId, OrderItem as _OrderItem, OrderStatus as _OrderStatus, PaymentMethod as _PaymentMethod, Price as _Price, Product as _Product, Time as _Time, TransferAdminResult as _TransferAdminResult, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async checkout(arg0: DeliveryAddress, arg1: PaymentMethod): Promise<OrderId> {
        if (this.processError) {
            try {
                const result = await this.actor.checkout(arg0, to_candid_PaymentMethod_n3(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async claimAdminRole(): Promise<ClaimAdminResult> {
        if (this.processError) {
            try {
                const result = await this.actor.claimAdminRole();
                return from_candid_ClaimAdminResult_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async transferAdminRole(): Promise<TransferAdminResult> {
        if (this.processError) {
            try {
                const result = await this.actor.transferAdminRole();
                return from_candid_TransferAdminResult_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_ClaimAdminResult_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ClaimAdminResult): ClaimAdminResult {
...
function from_candid_TransferAdminResult_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TransferAdminResult): TransferAdminResult {
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        user: value.user,
        totalAmountPkr: value.totalAmountPkr,
...
function from_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "cashOnDelivery" in value ? PaymentMethod.cashOnDelivery : "onlineCard" in value ? PaymentMethod.onlineCard : value;
}
...
function from_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "authenticationError" in value ? TransferAdminResult.authenticationError : "anonymousCaller" in value ? TransferAdminResult.anonymousCaller : "success" in value ? TransferAdminResult.success : value;
}
function from_candid_variant_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "alreadyExists" in value ? ClaimAdminResult.alreadyExists : "anonymousCaller" in value ? ClaimAdminResult.anonymousCaller : "success" in value ? ClaimAdminResult.success : value;
}
